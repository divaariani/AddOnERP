...
void main() {
  runApp(MaterialApp(
    home: LaporanReleaseView(),
  ));
}

class LaporanReleaseView extends StatefulWidget {
  const LaporanReleaseView({Key? key}) : super(key: key);
  @override
  State<LaporanReleaseView> createState() =>
      _LaporanReleaseViewState();
}
...
class _CustomButtonState extends State<CustomButton> {
  ...
  void initState() {
    super.initState();
    isCurrentPage = widget.targetPage.runtimeType == LaporanReleaseView;
  }
